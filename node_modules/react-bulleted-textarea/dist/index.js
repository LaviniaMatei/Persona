...
var BulletedTextArea = function BulletedTextArea(props) {
  ...
  var _useState = React.useState(values.length > 0 ? values.length : 1),
      lines = _useState[0],
      setLines = _useState[1];

  var _useState2 = React.useState(values.join('\n')),
      value = _useState2[0],
  ...
  return React.useMemo(function () {
    ...
    return React__default.createElement(Container, Object.assign({
      height: height
    }, rest), React__default.createElement(BulletContainer, null, bullets.map(function (bullet, i) {
      return React__default.createElement(Bullet, {
        key: "bullet-" + i
      }, bullet);
...
var BulletAdornment = function BulletAdornment(props) {
  var bulletChar = props.bulletChar,
      lines = props.lines;
  var bullets = new Array(lines).fill(bulletChar);
  return React__default.createElement(StyledAdornment, {
    position: 'start'
...
var MuiBulletedTextArea = function MuiBulletedTextArea(props) {
  ...
  return React__default.createElement(TextField, Object.assign({
    ...
    multiline: true,
    InputProps: {
      startAdornment: React__default.createElement(BulletAdornment, {
...
exports.BulletedTextArea = BulletedTextArea;
exports.MuiBulletedTextArea = MuiBulletedTextArea;
